  ...
  createProfileDropdown() {
    ...
    dd.innerHTML = `
      ...
      <div class="py-2">
        ...
        ${isAniListUser ? `
        ` : `
          <a href="/auth/anilist/link" class="flex items-center px-4 py-2 text-sm text-white hover:bg-white/5 transition-colors" role="menuitem">
        ...
        `}
        <a href="/settings" class="flex items-center px-3 py-2 text-sm text-white hover:bg-white/5 transition-colors" role="menuitem">
