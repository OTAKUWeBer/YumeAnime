...
class MiruroCatalogService:
    ...
    def _normalize_anime(self, item: Dict[str, Any]) -> Dict[str, Any]:
        """Normalize a Miruro API result to HiAnime catalog shape"""
    ...
    async def genre(self, name: str, page: int = 1) -> Dict[str, Any]:
        ...
        animes = [self._normalize_anime(item) for item in results]
    ...
    async def category(self, name: str, page: int = 1) -> Dict[str, Any]:
        ...
        # Map HiAnime category names to Miruro endpoints/filters
        category_map = {
            "trending": ("trending", {}),
            "popular": ("popular", {}),
    ...
    async def anime_about(self, anime_id: str) -> Dict[str, Any]:
        ...
        # Wrap in HiAnime-compatible structure for watchlist enrichment
        if info:
            return {
                "anime": {
                    "info": {
