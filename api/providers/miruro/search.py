...
class MiruroSearchService:
    ...
    def _normalize_search_result(self, item: Dict[str, Any]) -> Dict[str, Any]:
        """Normalize a Miruro search result to HiAnime-compatible shape"""
    ...
    async def search(
        ...
        *,
        ...
        Returns data in HiAnime-compatible format
        """
        ...
        animes = [self._normalize_search_result(item) for item in results]
    ...
    async def search_suggestions(self, q: str) -> Dict[str, Any]:
        ...
        # Normalize each suggestion to HiAnime-compatible shape
        normalized = []
